...
import static com.basso.basso.utils.PreferenceUtils.RECENT_LAYOUT;
...
import com.basso.basso.loaders.RecentLoader;
...
public class RecentFragment extends Fragment implements LoaderCallbacks<List<Album>>,
    ...
    private class MyContentObserver extends ContentObserver {
        ...
        public void onChange(boolean selfChange,  Uri uri) {
            ...
            getLoaderManager().restartLoader(RecentFragment.LOADER, null, RecentFragment.this);
        }
    }
}